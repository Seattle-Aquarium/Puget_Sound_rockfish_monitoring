...
#graph of sampling effort, with season 700x500
ggplot(meta, aes(x=Year, y=Site)) + 
  geom_point(alpha=0.5, size=3, color="black", aes(shape=Season)) +
  scale_shape_manual(values=c(21,3,24,25))+
  theme_cowplot()
...
#Figure 2: species observed by site over time 800x600
